...
import  OAG from '@/public/assets/images/OAG.jpg'
import  ABI from '@/public/assets/images/ABI.jpg'
      ...
      <div className='w-full flex flex-col items-center justify-center gap-28 mt-10'>
        ...
        items-end text-right z-10'>
          ...
          >
            ...
            <h3 className='text-2xl font-bold'>Online Art Gallery</h3>
            <p className='bg-[#112240] text-sm md:text-base p-2 xl:-mr-16 md:p-6 rounded-md'>
            An Online Art Gallery which inludes<span className='text-textGreen'> Authentication using JWT</span>, state management using react useState,
             also used <span className='text-textGreen'>  MongoDB as database</span> and Tailwind CSS for styling entire application.
            </p>
            <ul className=' text-xs md:text-sm font-titleFont tracking-wide flex gap-2
            md:gap-5 justify-between text-textDark'>
...
<div className='w-full flex flex-col items-center justify-center gap-28 mt-10'>
        ...
        items-end text-right xl:-ml-16 z-10'>
          ...
          >
            ...
            <h3 className='text-2xl font-bold'>Form Page</h3>
            <p className='bg-[#112240] text-sm md:text-base p-2 md:p-6 rounded-md'>
           
            A Login page  
            created with ReactJs,Firebase, 
            <span className='text-textGreen'> Firebase for authentication</span>, Redux for state management,
             AOS, <span className='text-textGreen'> Styled-components</span> and Material-UI.
            </p>
            <ul className=' text-xs md:text-sm font-titleFont tracking-wide flex gap-2
