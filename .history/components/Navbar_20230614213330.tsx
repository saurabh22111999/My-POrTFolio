    ...
    px-4">
      <div className='max-w-container h-full mx-auto py-1 font-titleFont flex items-center
        ...
        <div className='w-6 h-5 flex flex-col justify-between items-center mdl:hidden text-4xl text-textGreen cursor-pointer overflow-hidden group'>
          ...
          <span className='w-full h-[2px] bg-textGreen inline-flex transform group-hover:translate-x-0 translate-all ease-in-out duration-300'></span> 
          <span className='w-full h-[2px] bg-textGreen inline-flex transform group-hover:translate-x-3 translate-all ease-in-out duration-300'></span> 
