      ...
      <div className='w-full flex flex-col items-center justify-center gap-28 mt-10'>
        ...
        items-end text-right xl:-ml-16 z-10'>
          ...
          >
            ...
            An Online Art Gallery which inludes  
            <span className='text-textGreen'> Authentication using JWT</span>, state management using react useState,
             AOS, <span className='text-textGreen'> also used MongoDB as database</span> and Tailwind CSS for styling entire application.
            </p>
